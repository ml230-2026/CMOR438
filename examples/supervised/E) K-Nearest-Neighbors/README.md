...
> ⚠️ The dataset file is too large to store in this repository (581,012 rows, ~75MB). Download `covtype.csv` from the link above, rename it to `Forest_Cover.csv`, and place it in the `data/` folder in VSCode before running the notebook.
