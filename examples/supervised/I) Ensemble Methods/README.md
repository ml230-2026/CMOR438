...
Ensemble Methods build on **Decision Trees** (covered in the previous notebook). The Random Forest is a special case of Bagging. Modern libraries like XGBoost and LightGBM are highly optimized Gradient Boosting implementations used widely in industry.
